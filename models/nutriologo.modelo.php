<?php
    ...
    class ModeloNutriologo
    {
        ...
        public static function mdlAgregarCalNutri($id_nutriologo, $calificacion, $id_usuario, $cita) {
            $stmt = Conexion::conectar()->prepare("INSERT INTO TB_CALIFICACION (FK_NUTRIOLOGO, CALIFICACION, FK_CITA, FK_USUARIO) VALUES (:FK_NUTRIOLOGO, :CALIFICACION, :FK_CITA, :FK_USUARIO)");
            $stmt->bindParam(":FK_NUTRIOLOGO", $id_nutriologo, PDO::PARAM_INT);
            $stmt->bindParam(":CALIFICACION", $calificacion, PDO::PARAM_INT);
            $stmt->bindParam(":FK_CITA", $cita, PDO::PARAM_INT);
